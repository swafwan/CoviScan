      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            ...
            child:
                // Adobe XD layer: 'covigemerator' (text)
                Text.rich(
              TextSpan(
                style: TextStyle(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 20.0, middle: 0.1932),
            child: Text(
              'Scan to record your footprint ',
              style: TextStyle(
                fontFamily: 'Quicksand',
                fontSize: 16,
            ...
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  ...
                  child: Text(
                    'This is the default tracker. \nYou may Generate custom tracker using \nGenerate New ',
                    style: TextStyle(
                      fontFamily: 'Quicksand',
                      fontSize: 16,
                      color: const Color(0x78707070),
                ...
                Pinned.fromPins(
                  ...
                  child:
                      // Adobe XD layer: 'qr-code (1)' (shape)
                      Container(
                    decoration: BoxDecoration(
